...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [140 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2226176, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 15854744; uint32_t buffer_offset
	}, ; 137: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 16025752; uint32_t buffer_offset
	}, ; 138: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2020352, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 16048312; uint32_t buffer_offset
	} ; 139: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 18068664, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [18068664 x i8] zeroinitializer, align 16
