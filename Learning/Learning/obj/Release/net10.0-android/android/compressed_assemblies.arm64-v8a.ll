...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [122 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12000136; uint32_t buffer_offset
	}, ; 119: Java.Interop
	%struct.CompressedAssemblyDescriptor {
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12193704; uint32_t buffer_offset
	} ; 121: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14216616, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14216616 x i8] zeroinitializer, align 1
